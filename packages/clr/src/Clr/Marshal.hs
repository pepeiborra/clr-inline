...
--
instance Marshal Text ClrString where
  marshal x f = do
    ...
    allocaBytes (lenBytes + 4) $ \(ptr::Ptr Word32)-> do
      ...
      f $ coerce $ castPtr ptr

instance Marshal String ClrString where
...
instance Unmarshal ClrString Text where
  unmarshal str = do
    let ptr = coerce str :: Ptr Word16
